...
{
    public class QuestNode_Root_Gravcore_GravshipGraveyard : QuestNode_Root_Gravcore
    {
        public override void RunInt()
        {
            ...
            {
                Log.Error("Could not find valid site tile for gravship graveyard quest.");
                return;
            }
            ...
            {
                new SitePartDefWithParams(InternalDefOf.VGE_GravshipGraveyard, new SitePartParams
                {
            ...
            quest.Letter(LetterDefOf.NeutralEvent, text, null, null, null, useColonistsFromCaravanArg: false, QuestPart.SignalListenMode.OngoingOnly, label: "VGE_GravshipGraveyardLetterLabel".Translate(), text: "VGE_GravshipGraveyardLetterText".Translate(), lookTargets: Gen.YieldSingle(site.Map));
